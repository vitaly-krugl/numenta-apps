...
from taurus_metric_collectors import config
from taurus_metric_collectors import logging_support
from taurus_metric_collectors import metric_utils
from taurus_metric_collectors.metric_utils import getMetricsConfiguration
from taurus_metric_collectors.text_utils import sanitize4ByteUnicode
from taurus_metric_collectors.twitterdirect import purge_old_tweets
...
class TweetForwarder(object):
  ...
  def queryNonMetricTweetBatch(cls, sqlEngine, minSeq, maxItems=None,
    ...
    :returns: a two-tuple (<last seq>, <items>); (None, None) if there are no
      ...
      taurus_metric_collectors/twitterdirect/tweet_export_schema.json
    """
