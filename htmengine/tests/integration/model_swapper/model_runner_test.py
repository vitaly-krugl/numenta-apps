...
class ModelRunnerIntTestCase(unittest.TestCase):
  ...
  def testRunModelWithFullThenIncrementalCheckpointsClassifierEnabled(self):
    """ Have model_runner create a full checkpoint, then incremental checkpoint.
    The model include an enabled classifier for multi-step best predictions.
    """
    self._auxTestRunModelWithFullThenIncrementalCheckpoints(
      classifierEnabled=True)


  def testRunModelWithFullThenIncrementalCheckpointsClassifierDisabled(self):
    """ Have model_runner create a full checkpoint, then incremental checkpoint.
    The model does not include an enabled classifier.
    """
    self._auxTestRunModelWithFullThenIncrementalCheckpoints(
