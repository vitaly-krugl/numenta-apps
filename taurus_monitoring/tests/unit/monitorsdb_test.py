...
from taurus_monitoring import monitorsdb, logging_support
from taurus_monitoring.monitorsdb import retryOnTransientErrors
...
@patch("taurus_monitoring.monitorsdb.sqlalchemy", autospec=True)
